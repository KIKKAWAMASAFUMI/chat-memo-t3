...
export function MemoContent({ snippetId }: MemoContentProps) {
  ...
  if (!snippet && !isLoading) {
    return (
      <main className="flex-1 flex flex-col items-center justify-center bg-[#f9f7f2] gap-4">
  ...
  return (
    <main className="flex-1 flex flex-col overflow-hidden bg-[#f9f7f2]">
      {/* Header */}
      <header className="bg-white border-b border-gray-200 px-4 lg:px-6 py-4 flex items-center gap-3 w-full">
        {/* Menu Button */}
        <button
          onClick={openSidebar}
          ...
          <div className="flex gap-3">
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                disabled={!inputValue.trim() || createMessage.isPending || isLoading}
